...
It will also show any links between the notes as lines. If the links come from properties their names will be visible on the lines. Links written in the text of a note can be hidden with the "Show links from note body" setting, leaving only the links that come from properties. 
